            ...
            <div class="row">
                <div class="col-12 new-slider-col">
                    ...
                    <div class="small-slider-col-wrapper">
                        <div class="breands-slider">
                            <?php foreach ($brands as $brand): ?>
                                <div class="breand-slider-item">
                                    <div class="breand-slider-item-wrapper">
                                        <a href="<?= Url::to(['/shop/catalog/search', 'SearchForm[brand][]' => $brand->id]) ?>">
                                            <?php if ($brand->image): ?>
                                                <img src="<?=$brand->getThumbFileUrl('image', 'thumb') ?>" alt="<?= $brand->image ?>">
                                            <?php else: ?>
                                                <img src="<?= Url::base()?>/img/no_image.png" alt="">
                                            <?php endif; ?>
