...
/* @var $reviews shop\entities\shop\product\Review [] */
...
<section class="s-product_page_info">
    <div class="container">
        <div class="custom_row">
            <div class="vd__photo--product column">
                <div class="vd__photo--product_vertical_wrapper">
                    <div class="product-slider-nav">

                        <?php if ($product->photos): ?>
                            <?php foreach ($product->photos as $photo): ?>
                                <div class="product-slider-nav-item">
                                    <div class="product-slider-nav-item-wrapper">
                                        <img src="<?= $photo->getThumbFileUrl('file', 'catalog_product_additional') ?>" alt="<?= $product->mainPhoto->file ?>">
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
                ...
                <div class="vd__photo--product_main_wrapper">
                        ...
                        <?php if ($product->photos): ?>
                            <?php foreach ($product->photos as $photo): ?>
                                <div class="product-slider-for-item">
                                    <div class="product-slider-for-item-wrapper">
                                        <div class="tile" data-scale="1.6" data-image="<?= $photo->getThumbFileUrl('file', 'catalog_origin') ?>"></div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
            ...
            <div class="vd__info--product column">
                <div class="vd__info--product-wrapper">
...
<!--                    <div class="color_modification">-->
<!--                        <div class="info_label">-->
<!--                            Цвет-->
<!--                        </div>-->
<!--                        <div class="color_modification-wrapper">-->
<!--                            <ul class="modification_color-list list-style list-vertival">-->
<!--                                <li>-->
<!--                                    <label class="radio_color">-->
<!--                                        <input type="radio" name="color">-->
<!--                                        <div class="radio__content_color" style="background-color: #ff3939"></div>-->
<!--                                    </label>-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <label class="radio_color">-->
<!--                                        <input type="radio" name="color">-->
<!--                                        <div class="radio__content_color" style="background-color: #ffc60c"></div>-->
<!--                                    </label>-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <label class="radio_color">-->
<!--                                        <input type="radio" name="color" checked>-->
<!--                                        <div class="radio__content_color" style="background-color: #313131"></div>-->
<!--                                    </label>-->
<!--                                </li>-->
<!--                                <li>-->
<!--                                    <label class="radio_color">-->
<!--                                        <input type="radio" name="color">-->
<!--                                        <div class="radio__content_color" style="background-color: #e5e5e5"></div>-->
<!--                                    </label>-->
<!--                                </li>-->
<!--                            </ul>-->
<!--                        </div>-->
<!--                    </div>-->
                    ...
                    <div class="characteristics_modification">
                        <div class="info_label">
                            Модификация
                        </div>
                        <div class="characteristics_wrapper">
                            <ul class="characteristics-list list-style list-vertival">
                                <?php if ($product->modifications): ?>
                                    <?php foreach ($product->modifications as $modification): ?>
                                        <li>
                                            <label class="radio_charcter <?= !$product->isAvailableModification($modification->id) ? ' disabled' : '' ?>" data-modification_id="<?= Html::encode($modification->id) ?>">
                                                <input type="radio" name="AddToCartForm[modification]" value="<?= Html::encode($modification->id) ?>" <?= !$product->isAvailableModification($modification->id) ? ' disabled' : '' ?>>
                                                <div class="radio__content_charcter"><?= Html::encode($modification->name) ?></div>
                                            </label>
                                        </li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                    ...
                    <div class="count_modification">
                        <div class="info_label">
                            Количество
                        </div>
                        <div class="more_product-wrapper">
                            <div class="minus"></div>
                            <input type="number" name="quantity" value="1" class="cout-product">
                            <div class="plus"></div>
                        </div>
                    </div>
    ...
    <div class="container info_text_about_product_container">
        <div class="custom_row">
            <div class="info_text_about_product column">
                <div class="info_text_about_product_wrapper">
                    <div class="info_text_about_product-title">
                        <div class="info_text_name">Описание</div>
                        <div class="info_text_nam_product">
                ...
                <div class="info_text_about_product_wrapper">
                    <div class="info_text_about_product-title">
                        <div class="info_text_name">Характеристики</div>
                        <div class="info_text_nam_product">
                            <?= Html::encode($product->name) ?>
                        </div>
                    </div>
                            ...
                            <?php if ($product->values):  ?>
                                <?php foreach ($product->values as $value): ?>
                                    <tr>
                                        ...
                                        <td class="product_description"><?= Html::encode($value->value) ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </tbody>
            ...
            <div class="reviews-column column">
                <div class="reviews-column-wapper" id="reviews-wrap-all">
                    <div class="eviews-column-button-add">
                        <div class="info_text_about_product_wrapper">
                            <div class="info_text_about_product-title">
                                <div class="info_text_name">Отзывы покупателей</div>
                                <div class="info_text_nam_product"><?= $product->getReviewsCount() ?></div>
                            </div>
                        </div>
                        <div class="reviews-column-button-add--button_wrapper">
                            <?php if (!Yii::$app->user->isGuest): ?>
                                <button class="yellow_light" id="open_add_rew">
                                    Написать отзыв
                                </button>
                            <?php else: ?>
                                <a href="<?= Url::to(['/login']) ?>" class="yellow_light" title="Ввойдите на сайт">
                                    Написать отзыв
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="add_reviews_block_main">
                        ...
                        <div id="first-tab-group" class="tabgroup">
                            <div id="tab1" class="form_group_wrapper_rewie">
                                <?php $form = ActiveForm::begin(['id' => 'form-review']) ?>
                                    ...
                                    <div class="form_group_wrapper_button">
                                        <a href="#" class="answer_modal_close standart_large_close">Отмена</a>
                                        <button type="submit" class="yellow_light">Написать отзыв</button>
                                    </div>
                                <?php ActiveForm::end() ?>
                            </div>
                            <div id="tab2" class="form_group_wrapper_rewie">
                    ...
                    <div class="reviews_wrapper">
                        ...
                        <div class="all_reviews_link">
                            <a href="<?= Url::to(['reviews', 'product' => $product->id]); ?>">
                                Смотреть все отзывы
    ...
    <div class="container products_galery_container">
        <div class="custom_row">
            <div class="products_galery column">
                <div class="custom_row">
                    <div class="column">
                        <div class="info_text_about_product_wrapper">
                            <div class="info_text_about_product-title">
                                <div class="info_text_name">Фотографии</div>
                                <div class="info_text_nam_product">
                                    <?= Html::encode($product->name) ?>
                                </div>
                            </div>
                ...
                <div class="custom_row">
                    <?php if ($product->photos): ?>
                        <?php foreach ($product->photos as $photo): ?>
                            <div class="products_galery_col column">
                                <a href="<?= $photo->getThumbFileUrl('file', 'catalog_origin') ?>">
                                    <img src="<?= $photo->getThumbFileUrl('file', 'catalog_list') ?>" alt="<?= $photo->file ?>">
                                </a>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
    ...
    <?php if (!empty($product->relateds)): ?>
        <div class="container product_bought_container">
            <div class="custom_row">
                    ...
                    <div class="custom_nuvbar_wrapper">
                        <button class="b-prev">
                            <span class="v-prev-icon icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="22" viewBox="0 0 12 22"><g><g><path fill="#313131" d="M11.692 21.883c.3-.3.3-.785 0-1.085L2.13 11.255l9.562-9.562A.767.767 0 1 0 10.607.608L.52 10.694a.748.748 0 0 0-.224.542.781.781 0 0 0 .224.543l10.086 10.086a.752.752 0 0 0 1.085.018z"></path></g></g></svg>
                            </span>
                        </button>
                        <button class="b-next">
                            <span class="v-next-icon icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="12" height="22" viewBox="0 0 12 22"><g><g><path fill="#313131" d="M.388 21.883c-.3-.3-.3-.785 0-1.085l9.561-9.543L.388 1.693A.767.767 0 1 1 1.473.608L11.56 10.694a.748.748 0 0 1 .224.542.781.781 0 0 1-.224.543L1.473 21.864a.752.752 0 0 1-1.085.02z"></path></g></g></svg>
                            </span>
                        </button>
                    </div>
                </div>
            ...
            <div class="custom_row">
                <div class="column product_bough-col">
                    <div class="product_bough-col-wrapper">
                        <div class="product_bought-slider">
                            <?php foreach ($product->relateds as $related): ?>
