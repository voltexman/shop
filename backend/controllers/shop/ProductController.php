...
class ProductController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $relatedProductsProvider = new ActiveDataProvider([
            'query' => $product->getRelateds()->orderBy('name'),
//            'key' => function (Modification $modification) use ($product) {
//                return [
//                    'product_id' => $product->id,
//                    'id' => $modification->id,
...
//            },
        ...
        return $this->render('view', [
            ...
            'relatedProductsProvider' => $relatedProductsProvider,
        ]);
    }
    ...
    public function actionRelated($id)
    {
        ...
        $relatedProductsForm = new RelatedProductsForm($product);
        if ($relatedProductsForm->load(Yii::$app->request->post()) && $relatedProductsForm->validate()) {
            try {
                $this->service->addRelatedProduct($product->id, $relatedProductsForm);
                return $this->redirect(['view', 'id' => $product->id]);
            } catch (\DomainException $e) {
                Yii::$app->errorHandler->logException($e);
                Yii::$app->session->setFlash('error', $e->getMessage());
